...
class XLerobotNoHead(Robot):
    ...
    config_class = XLerobotNoHeadConfig
    name = "xlerobot_no_head"

    def __init__(self, config: XLerobotNoHeadConfig):
    ...
    def send_action(self, action: dict[str, Any]) -> dict[str, Any]:
        ...
        if self.config.max_relative_target is not None:
            # Read present positions for left arm, right arm
