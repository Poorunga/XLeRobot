...
from .config_xlerobot_no_head import XLerobotNoHeadConfig, XLerobotNoHeadClientConfig


class XLerobotNoHeadClient(Robot):
    config_class = XLerobotNoHeadClientConfig
    name = "xlerobot_no_head_client"

    def __init__(self, config: XLerobotNoHeadClientConfig):
