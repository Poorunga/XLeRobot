...
@RobotConfig.register_subclass("xlerobot_no_head")
@dataclass
class XLerobotNoHeadConfig(RobotConfig):
...
@dataclass
class XLerobotNoHeadHostConfig:
...
@RobotConfig.register_subclass("xlerobot_no_head_client")
@dataclass
class XLerobotNoHeadClientConfig(RobotConfig):
    # Network Configuration
    remote_ip: str
    port_zmq_cmd: int = 5555
    port_zmq_observations: int = 5556
