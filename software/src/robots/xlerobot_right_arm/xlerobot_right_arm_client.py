...
from .config_xlerobot_right_arm import XLerobotRightArmConfig, XLerobotRightArmClientConfig


class XLerobotRightArmClient(Robot):
    config_class = XLerobotRightArmClientConfig
    name = "xlerobot_right_arm_client"

    def __init__(self, config: XLerobotRightArmClientConfig):
